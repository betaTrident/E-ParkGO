...
const DOMAIN_ERROR_STATUS: Record<string, { code: ApiErrorCode; status: number }> = {
  ...
  QUOTE_EXPIRED: { code: 'QUOTE_EXPIRED', status: 422 },
  PAYMENT_REQUIRED: { code: 'PAYMENT_REQUIRED', status: 422 },
  PAYMENT_ALREADY_RECORDED: { code: 'PAYMENT_ALREADY_RECORDED', status: 409 },
  INSUFFICIENT_CASH: { code: 'INSUFFICIENT_CASH', status: 422 },
  SHIFT_REQUIRED: { code: 'SHIFT_REQUIRED', status: 422 },
  DUPLICATE_PAYMENT_REFERENCE: { code: 'DUPLICATE_PAYMENT_REFERENCE', status: 409 },
  SESSION_CANCELLED: { code: 'SESSION_CANCELLED', status: 409 },
